public class DoublyLinkedList<E>{
    ...
    /**
     * This is the Doubly Linked list class given to us by instructor Daniele Defrance. The class creates a
     * Doubly linked list, and nodes to be connected. The class utilizes methods designed from the java API
     * to create the desired linked list. We will use this class for our methods to create stacks and queues.
     * @param <E>
     */
